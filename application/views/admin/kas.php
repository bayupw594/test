...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Admin Kas</h1>
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<ul class="nav nav-pills nav-justified" style="">
				            <li class="active"><a data-toggle="tab" href="#dp">Lihat Kas</a></li>
				            <li><a data-toggle="tab" href="#masuk">Input Kas Masuk</a></li>  
							<li><a data-toggle="tab" href="#lunas">Input Kas Keluar</a></li>  
				        </ul>
				        <div class="tab-content"> <!-- tab data pinjaman start !-->
				        	...
				        	<div id="lunas" class="tab-pane fade in"><!-- lunas start !-->
				        		<div class="table-responsive"> <!--tabel responsive-->
					        		<div class="col-md-12">
					        			<form method="post" action="<?php echo base_url() ?>admin/kas/keluar">
					        				<div class="form-group row">
											    <label for="jumlah_keluar" class="col-sm-2 form-control-label">Jumlah Kas Keluar</label>
											    <div class="col-sm-10">
											      <input type="text" class="form-control" name="jumlah_keluar" placeholder="Jumlah Kas Keluar">
											    </div>
											 </div>
											 <div class="form-group row">
											    <label for="jumlah_keluar" class="col-sm-2 form-control-label">Keterangan</label>
											    <div class="col-sm-10">
											      <textarea class="form-control" name="keterangan" placeholder="Seperti Beli Aqua, Dan Lain Lain"></textarea>
											    </div>
											 </div>
				        	...
				        	<div id="masuk" class="tab-pane fade in"><!-- masuk start !-->
				        		<div class="table-responsive"> <!--tabel responsive-->
					        		<div class="col-md-12">
					        			<form method="post" action="<?php echo base_url() ?>admin/kas/masuk">
					        				<div class="form-group row">
											    <label for="jumlah_keluar" class="col-sm-2 form-control-label">Jumlah Kas Masuk</label>
											    <div class="col-sm-10">
											      <input type="text" class="form-control" name="jumlah_masuk" placeholder="Jumlah Kas Masuk">
											    </div>
											 </div>
											 <div class="form-group row">
											    <label for="ket" class="col-sm-2 form-control-label">Keterangan</label>
											    <div class="col-sm-10">
											      <textarea class="form-control" name="ket" placeholder="Seperti Hasil Penjualan Oli, Dll"></textarea>
											    </div>
											 </div>
											 <input type="submit" class="btn btn-primary" value="Submit" />
					        			</form>
