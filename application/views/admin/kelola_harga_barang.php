	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Kelola Harga Apparel</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Admin Kelola Harga Apparel</h1>
				<div class="panel panel-default">
					<div class="panel-heading">Pilih Menu Yang Ingin Anda Kelola : </div>
					<div class="panel-body">
						<ul class="nav nav-pills nav-justified" style="">
				            <li class="active"><a data-toggle="tab" href="#view_motor">Lihat Data Harga Apparel</a></li> 
				            <li><a data-toggle="tab" href="#input_motor">Input Data Harga Apparel</a></li>     
				        </ul>
				        <div class="tab-content"> <!-- tab data motor start !-->
				        			...
				        			"name" data-sort-order="desc">
							            <thead>
							                <tr>
							                    ...
							                    <th data-field="nama-pemilik"  data-sortable="true"> Nama Apparel</th>
							                    <th data-field="type"  data-sortable="true"> Harga</th>
							            ...
							            <tbody>
							                ...
							                ?>
							                    <tr>
							                        ...
							                        <td>
							                        	<a type="button" data-toggle="modal" data-target="#konf_update" href="<?php echo base_url(); ?>admin/kelola_harga_barang/update/<?php echo $row->id_harga?>" class="btn btn-sm btn-warning"><span class="glyphicon glyphicon-edit"></span></a>
							                        	<a type="button" onclick="return confirm('apakah anda yakin ingin menghapus?');" href="<?php echo base_url(); ?>admin/kelola_harga_barang/hapus/<?php echo $row->id_harga?>" class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-trash"></span></a>
							                        </td>
							                    </tr>
							                <?php
							                    $i++;
				        	...
				        	<div id="input_motor" class="tab-pane fade"> <!-- input data motor start !-->
				        		<div class="col-md-12">
				        			<form method="post" action="<?php echo base_url(); ?>admin/kelola_harga_barang/savedata">
					                     <div class="form-group row">
										    <label for="nama_pemilik1" class="col-sm-2 form-control-label">Nama Apparel</label>
										    <div class="col-sm-10">
										      <input type="text" id="nama_barang" class="form-control" name="nama_barang" placeholder="Nama Barang">
										    </div>
										 </div> 
										 <div class="form-group row">
										    <label for="types1" class="col-sm-2 form-control-label">Harga</label>
										    <div class="col-sm-10">
