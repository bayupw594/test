    ...
    <div class="modal-body form-group">
        <form method="post" action="<?= base_url()?>admin/peminjamanlunas/peng">
            <table class="table table-striped">
                ...
                <label for="biaya_lain" >Biaya Lain-Lain (Kerusakan, Tilang)</label>
                <div class="form-group row">
                    <div class="col-sm-10">
                        <?php
                            foreach ($kembali->result() as $kmbali) {
                        ?>
                               <input id="biaya_lain" type="text" class="form-control"  value="<?php echo $kmbali->biaya_lain; ?>" readonly="readonly"/>
                        <?php
                            }
                        ?>
                    </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-10">
                        <?php
                            foreach ($kembali->result() as $kmbali) {
                        ?>
                              <textarea id="keterangan" class="form-control" type="text" placeholder="<?php echo $kmbali->keterangan; ?>" readonly="readonly"></textarea>
                        <?php
                            }
                        ?>
                    </div>
