...
<body>
    <div class="modal-header">
        ...
        <h4 class="modal-title">Print Sharing Profit</h4>
    </div>      
    <div class="modal-body">
    <?php echo validation_errors(); ?>
    <?php echo form_open('admin/kelola_motor/laporan_maintenance'); ?>
        <div class="form-group row">
            <label for="nama_anggota" class="col-sm-3 form-control-label"> Nama Anggota </label>
            <div class="col-sm-8">
            
                <?php 
                foreach ( $listmotor->result() as $motor ) :
                ?>
                    <input type="text" name="nama" value="<?php echo $motor->No_Registrasi; ?>" readonly="readonly"/>
                    <input type="hidden" name="nama_anggota" value="<?php echo $motor->No_Registrasi; ?>" />
                <?php endforeach; ?>
