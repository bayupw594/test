	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Kelola Harga Barang</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Lihat Harga Barang</h1>
				<div class="panel panel-default">
					<div class="panel-heading">Berikut Adalah List Harga Barang</div>
				        			...
				        			"name" data-sort-order="desc">
							            <thead>
							                <tr>
							                    ...
							                    <th data-field="nama-pemilik"  data-sortable="true"> Nama Barang</th>
