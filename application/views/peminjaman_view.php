	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Lihat Pinjaman</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Lihat Pinjaman</h1>
				        			...
				        			"name" data-sort-order="desc">
							            <thead>
							                <tr>
							                    ...
							                    <th data-field="manage"  data-sortable="false"> Action</th>
							                </tr>
							            </thead>
							            <tbody>
							                <?php
							            ...
							            <tbody>
							                ...
							                ?>
							                    <tr>
							                        ...
							                        <td><?=$row->Tanggal?></td>
							                        <td>
							                            <a type="button" data-toggle="modal" data-target="#lihat_lunas" href="<?php echo base_url(); ?>admin/peminjamanlunas/lihatpin/<?php echo $row->Id_Peminjamanan?>" class="btn btn-sm btn-info"><span class="glyphicon glyphicon-search"></span></a>
							                        </td>
							                        <td>
