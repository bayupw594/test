...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class=""><a href="#"><span class="glyphicon glyphicon-dashboard"></span> Dashboard</a></li>
			<li class="parent ">
				<a href="#">
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Berikut Adalah List Motor Yang Sudah Dikembalikan</div>
				        ...
				        "name" data-sort-order="desc">
				            <thead>
				                <tr>
				                    ...
				                    <th data-field="tgl-pinjam" data-checkbox="true"> Tanggal Pinjam</th>
				                    <th data-field="tgl-kembali" data-checkbox="true"> Tanggal Kembali</th>
				                    <th data-field="alamat" data-checkbox="true"> Denda</th>
